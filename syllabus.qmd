...
This is a 3 credit course offered as an elective, which counts towards the Environmental Systems and Data Analytics focus area in the Environmental Engineering major.
...
The term project can be completed individually or in groups of 2. Students will provide updates throughout the semester corresponding to the various tasks discussed in each module and will submit a final report at the end of the semester. The deliverables are:
  ...
  * A calibration exercises applying calibration and uncertainty quantification methods from class;
  * Assessments of the model performance based on the data;
...
# set headers
headers_idx = [1, 6, 12, 16, 24, 28, 32]
headers = DataFrame([
