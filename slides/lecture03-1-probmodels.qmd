...
## Processes Contributing to SLR

![Sea Level Processes](figures/sea-processes.png)
...
![Sea Level Budget](figures/slr-budget.png)

::: {.caption}
Source: @Fox-Kemper2021-ni
:::
...
Want to split probability model into two parts:

* Influences/expectations (**generative**);
* Modeling errors/stochastic components (**residual**).
