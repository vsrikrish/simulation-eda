...
## Emulation and Different Samples
...
surrogate_rand = Kriging(xrand, yrand, lower_bound, upper_bound)
surrogate_sobol = Kriging(xsobol, ysobol, lower_bound, upper_bound)

plot!(p, xs, surrogate_rand.(xs), label = "Surrogate function",
    ribbon = x -> std_error_at_point(surrogate_rand, x), color=:blue, alpha=0.3, linewidth=2)
plot!(p, xs, surrogate_sobol.(xs), label = "Surrogate function",
