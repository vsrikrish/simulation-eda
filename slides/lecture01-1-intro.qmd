...
::: {.center}
![Modes of Data Analysis](figures/data_settings.png)
:::
...
timeline
      ...
      Model Evaluation (Weeks 8-9): Cross-Validation
                      : Model Selection
      Useful Models (Weeks 10-12): Extreme Values
                                 : Missing Data
                                 : Latent Variable
      Experimental Design (Weeks 13-14): Confounds
...
- One student responsible for leading the discussion on that Wednesday.
